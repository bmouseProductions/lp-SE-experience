                    ...
                    <div className='pt-10 md:py-5 md:my-0 px-5 md:px-10 lg:px-16 xl:px-20 h-full'>
                        <div className='w-full h-full md:max-w-[60%] xl:max-w-[650px] flex flex-col md:justify-center gap-7 md:gap-5 xl:gap-10'>
                            ...
                            <span className='font-franieLight'>
                                Prepare-se para um evento inesquecível que une emoção, inovação e networking.
                            </span>
                    ...
                    <SwiperSlide>
                        <div className='p-5 w-full h-full flex flex-col bg-[#463def] rounded-2xl '>
                            ...
                            <div className='space-y-3 my-3'>
                                ...
                                <span className='font-franieLight'>
                                    <strong>Tempo:</strong> (13:45 - 14:30)
                                </span>
                            </div>
                        </div>
                    </SwiperSlide>
                    ...
                    <SwiperSlide>
                        <div className='p-5 w-full h-full flex flex-col bg-[#463def] rounded-2xl '>
                            ...
                            <div className='space-y-3 my-3'>
                                ...
                                <span className='font-franieLight'>
                                    <strong>Tempo:</strong> (14:30 - 15:30)
                                </span>
                            </div>
                        </div>
                    </SwiperSlide>
                    ...
                    <SwiperSlide>
                        <div className='p-5 w-full h-full flex flex-col bg-[#463def] rounded-2xl '>
                            ...
                            <div className='space-y-3 my-3'>
                                ...
                                <span className='font-franieLight'>
                                    <strong>Tempo:</strong> (15:45 - 16:30)
                                </span>
                            </div>
                        </div>
                    </SwiperSlide>
                    ...
                    <SwiperSlide>
                        <div className='p-5 w-full h-full flex flex-col bg-[#463def] rounded-2xl '>
                            ...
                            <div className='space-y-3 my-3'>
                                ...
                                <span className='font-franieLight'>
                                    <strong>Tempo:</strong> (16:45 - 17:45)
                                </span>
                            </div>
                        </div>
                    </SwiperSlide>
                    ...
                    <SwiperSlide>
                        <div className='p-5 w-full h-full flex flex-col bg-[#0fff92] rounded-2xl '>
                            ...
                            <div className='space-y-3 my-3'>
                                ...
                                <span className='text-[#2f3033] font-franieLight'>
                                    <strong className='text-[#2f3033]'>Tempo:</strong> (18:00 - 19:30)
                                </span>
                            </div>
                        </div>
                    </SwiperSlide>
                    ...
                    <div className='hidden md:grid md:grid-cols-2 gap-5'>
                        ...
                        <div className='flex bg-[#463def] rounded-2xl overflow-hidden'>
                            <div className='py-5 pl-5 w-full max-w-[60%] flex flex-col justify-center gap-3'>
                                ...
                                <span className='font-franieLight'>
                                    <strong>Tempo:</strong> (14:45 - 15:30)
                                </span>
                            </div>
                        ...
                        <div className='flex bg-[#463def] rounded-2xl overflow-hidden'>
                            <div className='py-5 pl-5 w-full max-w-[60%] flex flex-col justify-center gap-3'>
                                ...
                                <span className='font-franieLight'>
                                    <strong>Tempo:</strong> (18:00 - 19:30)
                                </span>
                            </div>
